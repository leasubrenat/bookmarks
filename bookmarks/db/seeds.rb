...
b11 = Book.create(title: "Harry Potter and the Goblet of Fire", author: "J.K. Rowling", description: "The goblet turns blue", publisher: "Someone", weeks_on_list: 100, rank_this_week: 20)
b12 = Book.create(title: "Harry Potter and the Half-Blood Prince", author: "J.K. Rowling", description: "It's Snape!", publisher: "Same", weeks_on_list: 80, rank_this_week: 10)

Review.create(comment: "Amazing.", author: "Léa", book_id: b11.id)
Review.create(comment: "Still amazeballs", author: "Léa", book_id: b12.id)
